...
public class MergeLists {
    public static void main(String[] args) {
        ...
        // we will create a method which we will get two arrayList
        // then we will put that arraylists in one then return it

        ArrayList<Integer> num1s = new ArrayList<>(Arrays.asList(1,2,3,4));
        ArrayList<Integer> num2s = new ArrayList<>(Arrays.asList(5,6,7,8));
        //12345678
        ArrayList<Integer> result = mergeLists(num1s,num2s);
